...
import com.saurav.pixelmusic.data.database.AlbumArtThemeEntity
import com.saurav.pixelmusic.data.database.StoredColorSchemeValues
import com.saurav.pixelmusic.data.database.toComposeColor
import com.saurav.pixelmusic.utils.LocalArtworkUri
import com.saurav.pixelmusic.ui.theme.clearExtractedColorCache
import com.saurav.pixelmusic.ui.theme.extractSeedColor
import com.saurav.pixelmusic.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.saurav.pixelmusic.ui.theme.ColorExtractionConfig(
