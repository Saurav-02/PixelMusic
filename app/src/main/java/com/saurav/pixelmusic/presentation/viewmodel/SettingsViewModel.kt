...
import com.saurav.pixelmusic.data.backup.BackupManager
...
import com.saurav.pixelmusic.data.backup.model.RestoreResult
import com.saurav.pixelmusic.data.backup.model.ValidationError
...
import com.saurav.pixelmusic.data.preferences.PlaylistSuggestionSource
...
import com.saurav.pixelmusic.data.database.AiUsageEntity
...
import com.saurav.pixelmusic.data.ai.GeminiModel
import com.saurav.pixelmusic.data.ai.provider.AiClientFactory
import com.saurav.pixelmusic.data.ai.provider.AiProvider
import com.saurav.pixelmusic.data.preferences.LaunchTab
import com.saurav.pixelmusic.data.model.Song
import com.saurav.pixelmusic.data.service.player.HiFiCapabilityChecker
...
data class SettingsUiState(
    ...
    val appBackgroundStyle: com.saurav.pixelmusic.data.preferences.AppBackgroundStyle = com.saurav.pixelmusic.data.preferences.AppBackgroundStyle.DEFAULT,
...
private sealed interface SettingsUiUpdate {
    data class Group1(
        val appBackgroundStyle: com.saurav.pixelmusic.data.preferences.AppBackgroundStyle,
        val appBackgroundCustomUri: String,
...
class SettingsViewModel @Inject constructor(
    ...
    fun setPlayerDesignStyle(style: com.saurav.pixelmusic.data.preferences.PlayerDesignStyle) {
    viewModelScope.launch {
        ...
        viewModelScope.launch {
            combine<Any?, SettingsUiUpdate.Group1>(
                ...
                SettingsUiUpdate.Group1(
                    ...
                    appBackgroundStyle = values[15] as com.saurav.pixelmusic.data.preferences.AppBackgroundStyle,
    ...
    fun clearExoPlayerCache() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            try {
                com.saurav.pixelmusic.data.database.youtube.AppDatabase.clearDownloads(context)
                val db = com.saurav.pixelmusic.data.database.youtube.AppDatabase.getInstance(context)
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val models = modelStrings
                    ...
                    .distinct()
                    .map { com.saurav.pixelmusic.data.ai.GeminiModel(it, formatModelDisplayName(it)) }
...
fun setVerboseLoggingEnabled(enabled: Boolean) {
    ...
    fun setAppBackgroundStyle(style: com.saurav.pixelmusic.data.preferences.AppBackgroundStyle) {
        viewModelScope.launch {
