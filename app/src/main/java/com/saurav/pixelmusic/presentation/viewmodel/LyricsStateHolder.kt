...
import com.saurav.pixelmusic.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.saurav.pixelmusic.presentation.viewmodel.StablePlayerState>
    ) {
