...
interface MusicRepository {
     ...
     */
    fun getPaginatedSongs(sortOption: com.saurav.pixelmusic.data.model.SortOption, storageFilter: com.saurav.pixelmusic.data.model.StorageFilter): Flow<PagingData<Song>>

    /**
     * Returns paginated albums for efficient display in library tabs.
     */
    fun getPaginatedAlbums(
        sortOption: com.saurav.pixelmusic.data.model.SortOption,
        storageFilter: com.saurav.pixelmusic.data.model.StorageFilter = com.saurav.pixelmusic.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.saurav.pixelmusic.data.model.SortOption = com.saurav.pixelmusic.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.saurav.pixelmusic.data.model.StorageFilter = com.saurav.pixelmusic.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.saurav.pixelmusic.data.model.SortOption = com.saurav.pixelmusic.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.saurav.pixelmusic.data.model.StorageFilter = com.saurav.pixelmusic.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.saurav.pixelmusic.data.model.SortOption = com.saurav.pixelmusic.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.saurav.pixelmusic.data.model.StorageFilter = com.saurav.pixelmusic.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.saurav.pixelmusic.data.model.SortOption = com.saurav.pixelmusic.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.saurav.pixelmusic.data.model.StorageFilter = com.saurav.pixelmusic.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.saurav.pixelmusic.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.saurav.pixelmusic.data.model.StorageFilter = com.saurav.pixelmusic.data.model.StorageFilter.ALL
    ): Flow<List<com.saurav.pixelmusic.data.model.MusicFolder>>
