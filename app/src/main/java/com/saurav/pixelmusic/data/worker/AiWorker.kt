...
import com.saurav.pixelmusic.data.ai.AiOrchestrator
import com.saurav.pixelmusic.data.ai.AiSystemPromptType
import com.saurav.pixelmusic.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.saurav.pixelmusic.data.preferences.AiPreferencesRepository
