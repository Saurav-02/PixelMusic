...
import com.saurav.pixelmusic.data.database.LyricsEntity
...
import com.saurav.pixelmusic.data.database.SongEngagementEntity
import com.saurav.pixelmusic.data.database.TransitionDao
import com.saurav.pixelmusic.data.database.TransitionRuleEntity
import com.saurav.pixelmusic.data.preferences.PreferenceBackupEntry
import com.saurav.pixelmusic.data.preferences.UserPreferencesRepository
import com.saurav.pixelmusic.data.stats.PlaybackStatsRepository
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your PixelMusic backup was created successfully."
            )
        }
    }
