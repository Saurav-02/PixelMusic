package com.saurav.pixelmusic.data.ai
...
import com.saurav.pixelmusic.data.database.AiCacheEntity
...
class AiOrchestrator @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        return try {
            ...
            throw com.saurav.pixelmusic.data.ai.provider.AiProviderSupport.createException(
            ...
            val failure = com.saurav.pixelmusic.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.saurav.pixelmusic.data.ai.provider.AiClient,
        failure: com.saurav.pixelmusic.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.saurav.pixelmusic.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val resolvedTemperature = if (temperature == 0.7f) {
            when (type) {
                ...
                AiSystemPromptType.METADATA, AiSystemPromptType.LYRICS_RESCUE -> 0.1f
        ...
        val providersToTry = com.saurav.pixelmusic.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.saurav.pixelmusic.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
