...
import com.saurav.pixelmusic.MainActivity
import com.saurav.pixelmusic.R
import com.saurav.pixelmusic.data.model.PlayerInfo
import com.saurav.pixelmusic.data.model.PlaybackQueueItemSnapshot
import com.saurav.pixelmusic.data.model.PlaybackQueueSnapshot
...
import com.saurav.pixelmusic.data.service.player.TransitionController
import com.saurav.pixelmusic.ui.glancewidget.ControlWidget4x2
import com.saurav.pixelmusic.ui.glancewidget.PixelMusicGlanceWidget
import com.saurav.pixelmusic.ui.glancewidget.PlayerActions
import com.saurav.pixelmusic.ui.glancewidget.PlayerInfoStateDefinition
...
import com.saurav.pixelmusic.data.model.WidgetThemeColors
import com.saurav.pixelmusic.data.preferences.AlbumArtColorAccuracy
import com.saurav.pixelmusic.data.preferences.AlbumArtPaletteStyle
import com.saurav.pixelmusic.presentation.viewmodel.ColorSchemeProcessor
import androidx.compose.ui.graphics.toArgb
import com.saurav.pixelmusic.ui.glancewidget.BarWidget4x1
import com.saurav.pixelmusic.ui.glancewidget.GridWidget2x2
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.saurav.pixelmusic.data.preferences.ThemePreference
import com.saurav.pixelmusic.data.service.auto.AutoMediaBrowseTree
import com.saurav.pixelmusic.presentation.viewmodel.ColorSchemePair
import com.saurav.pixelmusic.utils.ArtworkTransportSanitizer
import com.saurav.pixelmusic.utils.MediaItemBuilder
import com.saurav.pixelmusic.di.AppScope
import com.saurav.pixelmusic.presentation.viewmodel.ListeningStatsTracker
import com.saurav.pixelmusic.data.remote.youtube.AutoQueueManager
import com.saurav.pixelmusic.data.remote.youtube.QueuePreloadManager
import com.saurav.pixelmusic.data.remote.youtube.ExoCache
import com.saurav.pixelmusic.data.remote.youtube.DatastoreRepository as YoutubeDatastoreRepository
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var musicDao: com.saurav.pixelmusic.data.database.MusicDao
    @Inject
    ...
    @Inject
    lateinit var replayGainManager: com.saurav.pixelmusic.data.media.ReplayGainManager
    @Inject
    ...
    @Inject
    lateinit var engagementDao: com.saurav.pixelmusic.data.database.EngagementDao

    private var scrobbleManager: com.saurav.pixelmusic.data.lastfm.ScrobbleManager? = null
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.saurav.pixelmusic.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.saurav.pixelmusic.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.saurav.pixelmusic"
    ...
    override fun onCreate() {
        ...
        scrobbleManager = com.saurav.pixelmusic.data.lastfm.ScrobbleManager(scope = serviceScope)
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.saurav.pixelmusic.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.saurav.pixelmusic.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.saurav.pixelmusic.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
    ...
    private suspend fun updateGlanceWidgets(playerInfo: PlayerInfo) = withContext(Dispatchers.IO) {
        try {
            ...
            if (glanceIds.isNotEmpty() || barGlanceIds.isNotEmpty() || controlGlanceIds.isNotEmpty() || gridGlanceIds.isNotEmpty()) {
                ...
                timber.log.Timber.tag("MusicService").d("No active Glance app widgets found for update.")
            }
        } catch (e: Exception) {
