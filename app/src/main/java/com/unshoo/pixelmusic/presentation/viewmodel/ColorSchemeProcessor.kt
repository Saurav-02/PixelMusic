...
import com.unshoo.pixelmusic.data.database.AlbumArtThemeEntity
import com.unshoo.pixelmusic.data.database.StoredColorSchemeValues
import com.unshoo.pixelmusic.data.database.toComposeColor
import com.unshoo.pixelmusic.utils.LocalArtworkUri
import com.unshoo.pixelmusic.ui.theme.clearExtractedColorCache
import com.unshoo.pixelmusic.ui.theme.extractSeedColor
import com.unshoo.pixelmusic.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.unshoo.pixelmusic.ui.theme.ColorExtractionConfig(
