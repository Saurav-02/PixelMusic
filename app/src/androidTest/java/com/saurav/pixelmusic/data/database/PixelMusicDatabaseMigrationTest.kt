...
class PixelMusicDatabaseMigrationTest {
    ...
    fun migrateEveryExportedSchemaToLatest() {
        for (startVersion in 25..39) {
            ...
            helper.runMigrationsAndValidate(
                ...
                PixelMusicDatabaseVersion.LATEST,
                true,
                *ALL_MIGRATIONS
            ).close()
        }
    ...
    fun migration23To24RepairsSongsWithoutDateAddedBeforeCreatingIndexes() {
        ...
        try {
            PixelMusicDatabase.MIGRATION_23_24.migrate(db)
    ...
    private object PixelMusicDatabaseVersion {
        const val LATEST = 40
    }
