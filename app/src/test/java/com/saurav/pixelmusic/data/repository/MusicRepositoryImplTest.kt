...
import com.saurav.pixelmusic.data.database.SongEntity // Necesario para datos de prueba
import com.saurav.pixelmusic.data.database.AlbumEntity
import com.saurav.pixelmusic.data.database.ArtistEntity
import com.saurav.pixelmusic.data.model.Song // Para verificar el mapeo
...
import com.saurav.pixelmusic.data.database.TelegramDao
import dagger.Lazy
import io.mockk.*
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.saurav.pixelmusic.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.saurav.pixelmusic.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.saurav.pixelmusic.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.saurav.pixelmusic.data.telegram.TelegramRepository> = mockk()
