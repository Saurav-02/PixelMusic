package com.saurav.pixelmusic.data.backup

import android.content.Context
import android.net.Uri
import com.saurav.pixelmusic.data.backup.format.BackupReader
import com.saurav.pixelmusic.data.backup.format.BackupWriter
import com.saurav.pixelmusic.data.backup.history.BackupHistoryRepository
import com.saurav.pixelmusic.data.backup.model.BackupManifest
import com.saurav.pixelmusic.data.backup.model.BackupModuleInfo
import com.saurav.pixelmusic.data.backup.model.BackupSection
import com.saurav.pixelmusic.data.backup.model.BackupValidationResult
import com.saurav.pixelmusic.data.backup.model.DeviceInfo
...
import com.saurav.pixelmusic.data.backup.module.BackupModuleHandler
import com.saurav.pixelmusic.data.backup.restore.RestoreExecutor
import com.saurav.pixelmusic.data.backup.restore.RestorePlanner
import com.saurav.pixelmusic.data.backup.validation.ValidationPipeline
...
class BackupManagerTest {
        ...
        every { validationPipeline.validateFile(backupUri) } returns BackupValidationResult.Invalid(
            listOf(
                ValidationError(
                    ...
                    severity = com.saurav.pixelmusic.data.backup.model.Severity.WARNING
                )
            )
        )
    ...
    private fun restorePlan(
        ...
        return RestorePlan(
            ...
            backupUri = "content://pixelmusic/test-backup",
